...
const Footer = props => {
  return (
    <div className='w-full bg-black px-12 md:px-32 lg:px-16 pt-16 space-y-8 pb-8 flex flex-col lg:flex-row lg:divide-x lg:divide-white lg:space-y-0 lg:justify-between xl:px-32'>
